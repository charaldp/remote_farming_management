...
class Car extends Migration
{
    ...
    public function up()
    {
        Schema::create('cars', function (Blueprint $table) {
            ...
            $table->bigIncrements('engine_id');
            $table->bigIncrements('wheel_id');
            $table->bigIncrements('body_material_id');
            $table->string('name');
            $table->string('creation_type')->default('points2D');
            $table->multiPolygon('body_points')->default(
            ...
            $table->multiPolygon('wheel_center_positions')->default(new Polygon([new LineString([
