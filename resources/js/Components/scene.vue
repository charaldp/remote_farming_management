...
<script>
    ...
    import '../Models/Tire.js';
    import '../Models/Rim.js';
    export default {
        ...
        created() {
			...
			this.totalLength = 1.65 * sceneGeometry.boundingSphere.radius;
			this.sceneCenter = sceneGeometry.boundingSphere.center.clone();
			...
			this.camera.position.copy( (car.center.clone()).add(cameraOffset.applyAxisAngle(new Three.Vector3( 0, 1, 0 ), Math.atan(car.frontVector.z / car.frontVector.x))));
			...
			this.controls.target0 = car.center;
			this.controls.target = car.center;
        ...
        methods: {
            ...
            render() {
                ...
                this.car.transmission.clutch += !clutch ? (this.car.transmission.clutch < 1 ? 0.05 * this.timestep : 0 ) : (this.car.transmission.clutch > 0 ? - 0.05 * this.timestep * this.car.transmission.clutch : 0 );
